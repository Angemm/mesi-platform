...
<section class="py-20 bg-white">
    <div class="max-w-5xl mx-auto px-6">
        <div class="bg-white rounded-3xl border border-slate-100 shadow-xl p-8 md:p-12 grid md:grid-cols-2 gap-10 items-center mb-16">
            <div class="relative">
                <div class="absolute inset-0 rounded-3xl rotate-3 scale-105 opacity-15" style="background:linear-gradient(135deg,#2d6a4f,#52b788);"></div>
            ...
            <div>
                ...
                <p class="font-bold text-sm mb-4" style="color:#2d6a4f;">{{ $pasteurPrincipal->role }}</p>
                <div class="relative mb-6">
                    <svg class="absolute -top-3 -left-3 w-8 h-8 opacity-15" fill="#2d6a4f" viewBox="0 0 24 24"><path d="M14.017 21V18c0-1.1.9-2 2-2h3c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1h-3c-1.1 0-2-.9-2-2V3h-3v18h3zm-11 0h3V18c0-1.1.9-2 2-2h3c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1H8c-1.1 0-2-.9-2-2V3H3v18z"/></svg>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-lg transition-shadow">
                <div class="relative aspect-[4/3] img-zoom">
                    ...
                    <div class="absolute inset-0" style="background:linear-gradient(to top,rgba(45,106,79,.7),transparent 50%);"></div>
