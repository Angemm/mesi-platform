...
Route::middleware(['auth', 'role:admin,editeur'])
    ...
    // Dons (lecture + statut seulement, pas de CRUD complet)
    ...
    // Horaires
    Route::get('horaires',      [AdminHoraireController::class, 'index'])->name('horaires.index');
    Route::put('horaires',      [AdminHoraireController::class, 'update'])->name('horaires.update');
    Route::delete('horaires/{horaire}', [AdminHoraireController::class, 'destroy'])->name('horaires.destroy');
